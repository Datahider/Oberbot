...
$translations = [
    ...
    'Проверка группы завершена.' => <<<FIN
                    ...
                    <b>/agent %mention%</b> или нажав кнопку ниже.
    ...
    'Необходимо задать тему заявки' => "Необходимо задать тему заявки:\n\n/create Тема заявки",
    'Актуальный список агентов: %all_agents%' => "Актуальный список агентов: %all_agents%\n\nИнструкция по работе агента: https://oberdesk.ru/for-agents/working-loop/",
    'Привет %mention%! Пожалуйста ознакомьтесь с инструкцией по созданию задач' => <<<FIN
            Привет %mention%! 
                
            Пожалуйста ознакомьтесь с <a href='https://oberdesk.ru/for-users/how-to-create-task/'>инструкцией по созданию задач</a> и правилами группы.
                
            Для просмотра правил жмите сюда → /rules
            FIN,
    /// Help
    //
    ...
    'Сообщение помощи в группе' => <<<FIN
                    ...
                    <b>/hid</b>    - отправка скрытого комментария или конфиденциальной информации (например пароля).
                    <b>/sub</b>    - Создание подзадачи.
                    /unlink - Отключиться от задачи. Бот перестанет упоминать вас в уведомлениях.

                    <b>Основные команды агентов</b>
                    /take - взятие задачи и запуск учета времени. Используется без параметров.
                    <b>/wait</b> - постановка задачи на ожидание.
                        
                    Команды выделенные жирным при вводе без параметров выводят дополнительную справку.
    
                    <i><b>Если у вас остались вопросы</b>, вы можете пригласить специалиста поддержки системы <a href="https://oberdesk.ru">Oberdesk</a> в этот чат или написать в наш чат поддержки нажав одну из кнопок:</i>
                    FIN,
    ...
    /// Типы задач
    'type_1' => 'Задача',
    'type_2' => 'Срочная задача (повышенный тариф)',
    'type_3' => 'Неисправность',
    'type_4' => 'Личная консультация',
    'type_5' => 'Срочная консультация (повышенный тариф)',
    'type_6' => 'Неисправность затрагивающая нескольких пользователей',
    'type_7' => 'Неисправность в предоставляемых услугах',
    'type_8' => 'Запрос поддержки бота',
    'type_9' => 'Запрос поддержки бота в ЛС',
    
    /// Статусы задач
    'status_0'      => 'Новая',
    'status_1'      => 'В работе',
    'status_101'    => 'Ожидание оформления',
    'status_111'    => 'Закрыта',
    'status_102'    => 'Переоткрыта',
    'status_88'     => 'Ожидание ответа',
    'status_89'     => 'Ответ получен',
    'status_120'    => 'Архивная',
