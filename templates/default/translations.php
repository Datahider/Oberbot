...
$translations = [
    ...
    'Привет %mention%! Пожалуйста ознакомьтесь с инструкцией по созданию задач' => 'Привет %mention%! Пожалуйста ознакомьтесь с инструкцией по созданию задач: https://oberdesk.ru/for-users/how-to-create-task/',
    /// Help
    //
