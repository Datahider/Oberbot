...
$translations = [
    ...
    'Сообщение помощи в чате с ботом' => <<<FIN
            Если у вас есть вопрос — вы можете написать его прямо в этом чате. Он будет перенаправлен специалистам технической поддержки, которые ответят вам не более чем через 15 минут.
