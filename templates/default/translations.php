...
$translations = [
    ...
    'Приветственное сообщение' => <<<FIN
                    ...
                    Удобный инструмент для фрилансеров, сервисных компаний, а так же для организации внутренней службы технической поддержки.

                    При использовании бота всё взаимодействие между пользователями происходит в привычном интерфейсе Telegram. 
                        
                    Нет необходимости ставить сторонние приложения и ваша информация всегда остается с вами в специально созданных для этого группах.
    ...
    'Сообщение помощи в чате с ботом' => <<<FIN
            ...
            /start - начальное приветствие бота и краткое описание работы 

            /next - получение ссылки на следующую задачу из групп, где вы назначены агентом

            /agent - обзор групп, где вы агент, количества открытых задач в них и состояния таймера

            Полная документация на сайте oberdesk.ru/help            
            FIN,
