...
$translations = [
    ...
    'all' => 'Все группы',
    'Текущий активный список групп: <b>%active%</b>' => <<<FIN
                    Текущий активный список групп: <b>%active%</b>
    ...
    'Инструкции как создать группу 2' => 'Выберите кого вы хотите добавить в эту группу и не забудьте меня (@Οberbot) и нажмите Далее.',
    ...
    'Сообщение помощи в чате с ботом' => <<<FIN
            ...
            <b>/next</b> - получение ссылки на следующую задачу из групп, где вы назначены агентом. Можно указать список групп, например <u><b>/next work</b></u> (см. команду /list в группах)

            <b>/agent</b> - обзор групп, где вы агент, количества открытых задач в них и состояния таймера
